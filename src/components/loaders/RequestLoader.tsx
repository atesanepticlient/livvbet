...
const RequestLoader = () => {
  return (
    <div className="w-[35px] h-[35px] mx-auto">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 414 414">
        <defs>
          <linearGradient
            ...
            y2="100%"
          >
            <stop offset="0" className="pre-logo__color-2" />
            <stop offset="0.1" className="pre-logo__color-2" />
            <stop offset="0.2" className="pre-logo__color-2" />
            <stop offset="0.3" className="pre-logo__color-2" />
            <stop offset="0.4" className="pre-logo__color" />
            <stop offset="0.5" className="pre-logo__color" />
            <stop offset="0.6" className="pre-logo__color-2" />
            <stop offset="0.7" className="pre-logo__color-2" />
            <stop offset="0.8" className="pre-logo__color-2" />
            <stop offset="0.9" className="pre-logo__color-2" />
            <stop offset="1" className="pre-logo__color-2" />
          </linearGradient>
        </defs>

        <path
          id="pre-outer"
          className="pre-logo__outer-2"
